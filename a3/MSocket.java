...
public class MSocket{
    ...
    //public final double DROP_RATE= 1;
    ...
    private HashMap<PairKey<String, Double>, Boolean> rcvdEvent;
        ...
        public void run(){
            try{
                ...
                while(incoming != null){
                    ...
                    PairKey<String, Double> pk = new PairKey<String, Double>(in_packet.name, in_packet.sequenceNumber);
    ...
    */
    ...
    public MSocket(String host, int port) throws IOException{
        ...
        rcvdCount = 0;
        rcvdEvent = new HashMap<PairKey<String, Double>, Boolean>();
        sentCount = 0;
        rcvdBytes = 0;
        sentBytes = 0;
