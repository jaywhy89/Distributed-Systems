        ...
        public void keyPressed(KeyEvent e){
                try{
                        ...
                        // Spacebar fires.
                                ...
                                timer.scheduleAtFixedRate(new MyTimerTask(this){
                                  public void run(){
                                    try{ 
                                        System.out.println("before if");
                                        if(client.maze.getprojectileMap()){
                                            System.out.println("insdie if");
                                            eventQueue.put(new MPacket(getName(), MPacket.ACTION, MPacket.MOVEPROJECTILE));
                                        }else{                                        
                                            timer.cancel();
                                            timer.purge();
                                            System.out.println("dismissing clock");
                                        }
